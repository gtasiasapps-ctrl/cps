...
Υπηρεσίες (tagline): **Architecture – Engineering – Interior Design – Project Management – Real Estate Development (BREEAM Accredited)**.
...
- [x] **Instagram** — ✅ `https://www.instagram.com/cps_redea/` (+ `sameAs` στο JSON-LD).
- [ ] **Facebook** — ακόμα `href="#"`
      (σχόλιο `▼▼ ΒΑΛΕ ΕΔΩ ΤΑ ΠΡΑΓΜΑΤΙΚΑ LINKS ▼▼` μέσα στο `.social` σε κάθε σελίδα)
- [x] **Γ.Ε.ΜΗ.** — ✅ **186189540000** (footer EL/EN + `identifier` στο JSON-LD)
