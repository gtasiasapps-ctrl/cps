...
const I18N = {
  el: {
    ...
    "ct.k1":"Διεύθυνση","ct.v1":"Κουμουνδούρου Αλέξανδρου 24, Άγιος Νικόλαος, Λάρισα","ct.v1b":"","ct.v1b2":"",
    "ct.k2":"Τηλέφωνο","ct.k3":"Email","ct.k4":"Ωράριο","ct.v4":"Δευ – Παρ · 09:00 – 17:00",
  ...
  en: {
    ...
    "ct.k1":"Address","ct.v1":"Koumoundourou Alexandrou 24, Agios Nikolaos, Larissa","ct.v1b":"","ct.v1b2":"",
    "ct.k2":"Phone","ct.k3":"Email","ct.k4":"Hours","ct.v4":"Mon – Fri · 09:00 – 17:00",
...
/* ══════════════════════════════════════════════════════════
   CAROUSEL (hero δεξιά) — φωτογραφίες μέσα στον φάκελο carousel/
   Βάλε ό,τι όνομα θες, με τη σειρά που θα παίζουν.
   Άδειο [] → το carousel δείχνει αυτόματα τις καρτέλες των έργων.
   ══════════════════════════════════════════════════════════ */
const CAROUSEL = [
  '01.jpg'
];
