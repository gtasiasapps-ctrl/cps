...
const I18N = {
  el: {
    ...
    "nl.title":"Newsletter","nl.text":"Νέα έργα, υλικά και ιδέες — μία φορά τον μήνα, χωρίς spam.","nl.btn":"Εγγραφή",
  ...
  en: {
    ...
    "nl.title":"Newsletter","nl.text":"New projects, materials and ideas — once a month, no spam.","nl.btn":"Subscribe",
